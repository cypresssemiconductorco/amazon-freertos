...
ifeq ($(CORE),CM0P)
$(error $(DEVICE) does not have a CM0+ core)
endif
...
$(error Incorrect part number $(DEVICE). Check DEVICE variable.)
endif
...
$(error No Flash memory size defined for $(DEVICE))
endif
...
$(error No SRAM memory size defined for $(DEVICE))
endif
...
$(error Could not resolve device series for linker script)
endif
...
CY_VSCODE_ARGS="s|&&MODUSPATH&&|$(CY_INTERNAL_TOOLS)|;"\
				...
				"s|&&PSOCFAMILY&&|$(CY_PSOC_ARCH)|;"\
				"s|&&MODUSSHELL&&|C:/cygwin64|;"
