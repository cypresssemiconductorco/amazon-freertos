...
ifeq ($(LIBNAME),)
	...
	echo "s|&&JSONINCLUDELIST&&|$(subst -I,,$(CY_RECIPE_INCLUDES))|" >> $(CY_VSCODE_TEMPFILE);\
	echo "s|&&JSONDEFINELIST&&|$(subst -D,,$(CY_RECIPE_DEFINES))|" >> $(CY_VSCODE_TEMPFILE);\
...
ifeq ($(LIBNAME),)
	...
	echo Generated Eclipse launch config files:
endif
...
get_app_info:
	...
	echo "SUPPORTED_TOOL_TYPES=$(CY_SUPPORTED_TOOL_TYPES)";\
...
CY_HELP_get_cfg_file=Returns the found configuration files.
get_cfg_file:
	@echo $(CY_CONFIG_FILES)
...
#
.PHONY: help help_default vscode eclipse check shared_libs get_env_info get_app_info get_cfg_file
