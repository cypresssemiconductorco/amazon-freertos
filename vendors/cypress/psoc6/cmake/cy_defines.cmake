...
if((NOT MCUBOOT_DIR) OR ("${MCUBOOT_DIR}" STREQUAL ""))
    set(MCUBOOT_DIR             "${AFR_ROOT_DIR}/../mcuboot")
else()
    get_filename_component(MCUBOOT_DIR "${MCUBOOT_DIR}" ABSOLUTE)
    message("MCUBoot directory: ${MCUBOOT_DIR}")
endif()
set(MCUBOOT_CYPRESS_DIR         "${MCUBOOT_DIR}/boot/cypress")
set(MCUBOOT_BOOTUTIL_DIR        "${MCUBOOT_DIR}/boot/bootutil")
set(MCUBOOT_BOOTUTIL_SRC_DIR    "${MCUBOOT_BOOTUTIL_DIR}/src")
set(MCUBOOT_BOOTUTIL_INC_DIR    "${MCUBOOT_BOOTUTIL_DIR}/include")

# signing scripts and keys from MCUBoot
set(IMGTOOL_SCRIPT_NAME         "./imgtool.py")
set(MCUBOOT_SCRIPT_FILE_DIR     "${MCUBOOT_DIR}/scripts")
set(MCUBOOT_KEY_DIR             "${MCUBOOT_CYPRESS_DIR}/keys")
set(MCUBOOT_CY_BOOTAPP_DIR      "${MCUBOOT_CYPRESS_DIR}/MCUBootApp")
set(MCUBOOT_BOOTAPP_CONFIG_DIR  "${MCUBOOT_CY_BOOTAPP_DIR}/config")
set(MCUBOOT_CYFLASH_PAL_DIR     "${MCUBOOT_CYPRESS_DIR}/cy_flash_pal")
set(MCUBOOT_SIGNATURE_DIR       "${cy_common_dir}/mcuboot_header")
