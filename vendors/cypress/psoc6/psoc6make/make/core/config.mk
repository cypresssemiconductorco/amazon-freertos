...
$(error Multiple device configuration files detected: $(CY_SEARCH_AVAILABLE_MODUS_SOURCES))
endif
endif
ifneq ($(words $(CY_SEARCH_AVAILABLE_CYBT_SOURCES)),1)
ifneq ($(words $(CY_SEARCH_AVAILABLE_CYBT_SOURCES)),0)
$(error Multiple BT configuration files detected: $(CY_SEARCH_AVAILABLE_CYBT_SOURCES))
endif
endif
ifneq ($(words $(CY_SEARCH_AVAILABLE_CYUSBDEV_SOURCES)),1)
ifneq ($(words $(CY_SEARCH_AVAILABLE_CYUSBDEV_SOURCES)),0)
$(error Multiple USBDEV configuration files detected: $(CY_SEARCH_AVAILABLE_CYUSBDEV_SOURCES))
endif
endif
