...
#
CY_BT_CONFIGURATOR_DEFAULT_DIR=$(CY_INTERNAL_TOOLS)/bt-configurator
CY_CAPSENSE_CONFIGURATOR_DEFAULT_DIR=$(CY_INTERNAL_TOOLS)/capsense-configurator
CY_CFG_BACKEND_CLI_DEFAULT_DIR=$(CY_INTERNAL_TOOLS)/cfg-backend-cli
CY_MCUELFTOOL_DEFAULT_DIR=$(CY_INTERNAL_TOOLS)/cymcuelftool-1.0
CY_PE_TOOL_DEFAULT_DIR=$(CY_INTERNAL_TOOLS)/cype-tool
CY_DEVICE_CONFIGURATOR_DEFAULT_DIR=$(CY_INTERNAL_TOOLS)/device-configurator
CY_DFUH_TOOL_DEFAULT_DIR=$(CY_INTERNAL_TOOLS)/dfuh-tool
CY_FW_LOADER_DEFAULT_DIR=$(CY_INTERNAL_TOOLS)/fw-loader
CY_COMPILER_DEFAULT_DIR=$(CY_INTERNAL_TOOLS)/gcc-7.2.1
CY_JRE_DEFAULT_DIR=$(CY_INTERNAL_TOOLS)/jre-1.0
CY_LIBRARY_MANAGER_DEFAULT_DIR=$(CY_INTERNAL_TOOLS)/library-manager
CY_MODUS_SHELL_DEFAULT_DIR=$(CY_INTERNAL_TOOLS)/modus-shell
CY_OPENOCD_DEFAULT_DIR=$(CY_INTERNAL_TOOLS)/openocd
CY_QSPI_CONFIGURATOR_DEFAULT_DIR=$(CY_INTERNAL_TOOLS)/qspi-configurator
CY_SEGLCD_CONFIGURATOR_DEFAULT_DIR=$(CY_INTERNAL_TOOLS)/seglcd-configurator
CY_SMARTIO_CONFIGURATOR_DEFAULT_DIR=$(CY_INTERNAL_TOOLS)/smartio-configurator
CY_USBDEV_CONFIGURATOR_DEFAULT_DIR=$(CY_INTERNAL_TOOLS)/usbdev-configurator
...
# Tool locations
#
CY_BT_CONFIGURATOR_DIR?=$(CY_BT_CONFIGURATOR_DEFAULT_DIR)
CY_CAPSENSE_CONFIGURATOR_DIR?=$(CY_CAPSENSE_CONFIGURATOR_DEFAULT_DIR)
CY_CFG_BACKEND_CLI_DIR?=$(CY_CFG_BACKEND_CLI_DEFAULT_DIR)
CY_MCUELFTOOL_DIR?=$(CY_MCUELFTOOL_DEFAULT_DIR)
CY_PE_TOOL_DIR?=$(CY_PE_TOOL_DEFAULT_DIR)
CY_DEVICE_CONFIGURATOR_DIR?=$(CY_DEVICE_CONFIGURATOR_DEFAULT_DIR)
CY_DFUH_TOOL_DIR?=$(CY_DFUH_TOOL_DEFAULT_DIR)
CY_FW_LOADER_DIR?=$(CY_FW_LOADER_DEFAULT_DIR)
CY_COMPILER_DIR?=$(CY_COMPILER_DEFAULT_DIR)
CY_JRE_DIR?=$(CY_JRE_DEFAULT_DIR)
CY_LIBRARY_MANAGER_DIR?=$(CY_LIBRARY_MANAGER_DEFAULT_DIR)
CY_MODUS_SHELL_DIR?=$(CY_MODUS_SHELL_DEFAULT_DIR)
CY_OPENOCD_DIR?=$(CY_OPENOCD_DEFAULT_DIR)
CY_QSPI_CONFIGURATOR_DIR?=$(CY_QSPI_CONFIGURATOR_DEFAULT_DIR)
CY_SEGLCD_CONFIGURATOR_DIR?=$(CY_SEGLCD_CONFIGURATOR_DEFAULT_DIR)
CY_SMARTIO_CONFIGURATOR_DIR?=$(CY_SMARTIO_CONFIGURATOR_DEFAULT_DIR)
CY_USBDEV_CONFIGURATOR_DIR?=$(CY_USBDEV_CONFIGURATOR_DEFAULT_DIR)
...
ifneq ($(findstring get_cfg_file,$(MAKECMDGOALS)),get_cfg_file)
