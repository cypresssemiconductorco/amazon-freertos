...
CY_HELP_get_cfg_file_VERBOSE=The file types can be specified by setting the CY_CONFIG_FILE_EXT variable.\
					E.g. "make get_cfg_file "CY_CONFIG_FILE_EXT=modus cybt cyusbdev"".
CY_HELP_get_app_info_VERBOSE=As with "get_cfg_file" target, the file types can be specified by setting the\
...
CY_HELP_CONFIG_VERBOSE=The CONFIG variable is not limited to Debug/Release. It can be\
						other values. However in those instances, the build system will not\
						configure the optimization flags.
...
#
CY_HELP_CY_IGNORE=Adds to the directory and file ignore list.
...
CY_HELP_CY_CONFIG_FILE_EXT=Specifies the configurator file extension.
CY_HELP_CY_CONFIG_FILE_EXT_VERBOSE=This variable accepts a space-separated list of configurator file extensions\
					that should be searched for when running the "get_cfg_file" and "get_app_info" targets.
...
CY_HELP_TARGETS_ALL=all getlibs build qbuild program qprogram debug qdebug clean help open config config_bt config_usbdev \
					eclipse check get_cfg_file get_app_info get_env_info printlibs
...
ifneq ($(CY_HELP),)
	...
	$(info                                                               )
	$(info =======================================                       )
	$(info $(CY_SPACE)Configurator make targets                          )
	$(info =======================================                       )
	...
	$(info $(CY_SPACE)get_cfg_file        $(CY_HELP_get_cfg_file))
