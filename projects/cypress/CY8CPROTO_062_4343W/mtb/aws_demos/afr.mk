...
LINKER_SCRIPT=$(wildcard $(CY_AFR_BOARD_APP_PATH)/TOOLCHAIN_$(TOOLCHAIN)/*.$(CY_AFR_TOOLCHAIN_LS_EXT))
...
SOURCES+=\
	...
	$(wildcard $(CY_AFR_BOARD_APP_PATH)/TOOLCHAIN_$(TOOLCHAIN)/*.S)\
	$(wildcard $(CY_AFR_BOARD_APP_PATH)/TOOLCHAIN_$(TOOLCHAIN)/*.s)\
...
SOURCES+=\
	$(wildcard $(CY_AFR_ROOT)/libraries/3rdparty/http-parser/*c)\
