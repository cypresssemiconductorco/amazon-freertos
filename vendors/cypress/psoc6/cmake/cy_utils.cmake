...
function(cy_filter_ignored arg_files)
    ...
    endforeach()
    list(FILTER to_ignore EXCLUDE REGEX "${CMAKE_BINARY_DIR}/.*")
    list(FILTER to_ignore EXCLUDE REGEX "^[ \t\r\n]*$")
...
function(cy_add_args_to_target target mode)
    ...
    set(linker_script "$ENV{CY_LINKER_PATH}/TOOLCHAIN_$ENV{CY_TOOLCHAIN}/$ENV{CY_LINKER_SCRIPT}$ENV{CY_LINKERSCRIPT_EXT}")
    else()
